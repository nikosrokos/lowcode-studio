...
**v0.6.52** · Studio-like low-code RPA for **VS Code / Cursor** on Mac, Windows, and Linux.
...
![version](https://img.shields.io/badge/version-0.6.52-0ea5e9)
...
**Extensions: Install from VSIX…** → `lowcode-studio-0.6.52.vsix` → reload window.
