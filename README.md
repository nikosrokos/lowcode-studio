...
**v0.6.51** · Studio-like low-code RPA for **VS Code / Cursor** on Mac, Windows, and Linux.
...
![version](https://img.shields.io/badge/version-0.6.51-0ea5e9)
...
**Extensions: Install from VSIX…** → `lowcode-studio-0.6.51.vsix` → reload window.
